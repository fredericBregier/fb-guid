...
/**
 * GUID implementation using:<br>
 * - 1 bytes = Version (8)<br>
 * - 4 bytes - 2 bits = Tenant Id (30)<br>
 * - 4 bytes = -1 bit Platform Id (31)<br>
 ...
 * Benchmark shows about 7 millions/s generated GUID.
 */
...
public final class GUID implements Comparable<GUID> {
  ...
  public GUID(final int tenantId) {
    this(tenantId, JvmProcessId.macAddressAsInt() & 0x7FFFFFFF);
  }
